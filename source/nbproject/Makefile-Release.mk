...
${OBJECTDIR}/Bibliographie.o: Bibliographie.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Bibliographie.o Bibliographie.cpp

${OBJECTDIR}/ContratException.o: ContratException.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ContratException.o ContratException.cpp

${OBJECTDIR}/Journal.o: Journal.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Journal.o Journal.cpp

${OBJECTDIR}/Ouvrage.o: Ouvrage.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Ouvrage.o Ouvrage.cpp

${OBJECTDIR}/Reference.o: Reference.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Reference.o Reference.cpp

${OBJECTDIR}/ReferenceException.o: ReferenceException.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReferenceException.o ReferenceException.cpp

${OBJECTDIR}/validationFormat.o: validationFormat.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/validationFormat.o validationFormat.cpp
...
${TESTDIR}/tests/BibliographieTesteur.o: tests/BibliographieTesteur.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNDEBUG -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/BibliographieTesteur.o tests/BibliographieTesteur.cpp


${TESTDIR}/tests/JournalTesteur.o: tests/JournalTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNDEBUG -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/JournalTesteur.o tests/JournalTesteur.cpp


${TESTDIR}/tests/OuvrageTesteur.o: tests/OuvrageTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNDEBUG -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/OuvrageTesteur.o tests/OuvrageTesteur.cpp


${TESTDIR}/tests/ReferenceTesteur.o: tests/ReferenceTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DNDEBUG -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ReferenceTesteur.o tests/ReferenceTesteur.cpp
...
${OBJECTDIR}/Bibliographie_nomain.o: ${OBJECTDIR}/Bibliographie.o Bibliographie.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DNDEBUG -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Bibliographie_nomain.o Bibliographie.cpp;\
	else  \
...
${OBJECTDIR}/ContratException_nomain.o: ${OBJECTDIR}/ContratException.o ContratException.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DNDEBUG -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ContratException_nomain.o ContratException.cpp;\
	else  \
...
${OBJECTDIR}/Journal_nomain.o: ${OBJECTDIR}/Journal.o Journal.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DNDEBUG -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Journal_nomain.o Journal.cpp;\
	else  \
...
${OBJECTDIR}/Ouvrage_nomain.o: ${OBJECTDIR}/Ouvrage.o Ouvrage.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DNDEBUG -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Ouvrage_nomain.o Ouvrage.cpp;\
	else  \
...
${OBJECTDIR}/Reference_nomain.o: ${OBJECTDIR}/Reference.o Reference.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DNDEBUG -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Reference_nomain.o Reference.cpp;\
	else  \
...
${OBJECTDIR}/ReferenceException_nomain.o: ${OBJECTDIR}/ReferenceException.o ReferenceException.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DNDEBUG -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReferenceException_nomain.o ReferenceException.cpp;\
	else  \
...
${OBJECTDIR}/validationFormat_nomain.o: ${OBJECTDIR}/validationFormat.o validationFormat.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DNDEBUG -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/validationFormat_nomain.o validationFormat.cpp;\
	else  \
